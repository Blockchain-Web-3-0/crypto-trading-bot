...
let ExchangeOrder = require('./exchange_order');

module.exports = class PairState {
    static get STATE_LONG() { return 'long'; }
    static get STATE_SHORT() { return 'short'; }
    static get STATE_CLOSE() { return 'close'; }
    static get STATE_CANCEL() { return 'cancel'; }
